...
## Buttons
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS25} [get_ports btnc]
...
# BTNU = start a bounded EIT/TIS measurement run (IP_1 debounces + edge-detects it
# in hardware; active high, idle 0).
# LVCMOS25, NOT the LVCMOS12 the Digilent master file suggests: btnu (B19) shares
# bank 17 with btnc (E18) and sw0..sw3, which this design already drives at 2.5 V.
# Mixing standards inside a bank is a hard DRC error (BIVC-1, "Conflicting Vcc
# voltages in bank 17") and fails place_design.
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS25} [get_ports btnu]; #IO_L24N_T3_17 Sch=btnu
...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS25 } [get_ports { sw0 }]; #IO_0_17 Sch=sw[0]
set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS25 } [get_ports { sw1 }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS25 } [get_ports { sw2 }]; #IO_L19P_T3_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS25 } [get_ports { sw3 }]; #IO_L6P_T0_17 Sch=sw[3]
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS25 } [get_ports { sw4 }]; #IO_L19P_T3_A22_15 Sch=sw[4]
set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS25 } [get_ports { sw5 }]; #IO_25_15 Sch=sw[5]
set_property -dict { PACKAGE_PIN P26   IOSTANDARD LVCMOS25 } [get_ports { sw6 }]; #IO_L10P_T1_D14_14 Sch=sw[6]
#set_property -dict { PACKAGE_PIN P27   IOSTANDARD LVCMOS33 } [get_ports { sw7 }]; #IO_L8P_T1_D11_14 Sch=sw[7]
...
set_property -dict {PACKAGE_PIN AH24 IOSTANDARD LVCMOS33} [get_ports eth_rst_b]
...
## PMOD Header JA
set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS25 } [get_ports { ja0 }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS25 } [get_ports { ja1 }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS25 } [get_ports { ja2 }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS25 } [get_ports { ja3 }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS25 } [get_ports { ja4 }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN T23   IOSTANDARD LVCMOS25 } [get_ports { ja5 }]; #IO_L5N_T0_D07_14 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS25 } [get_ports { ja6 }]; #IO_L4P_T0_D04_14 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN T21   IOSTANDARD LVCMOS25 } [get_ports { data_out[24] }]; #IO_L4N_T0_D05_14 Sch=ja_n[4]

## PMOD Header JB
set_property -dict { PACKAGE_PIN V29   IOSTANDARD LVCMOS25 } [get_ports { data_out[23] }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30   IOSTANDARD LVCMOS25 } [get_ports { data_out[22] }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V25   IOSTANDARD LVCMOS25 } [get_ports { data_out[21] }]; #IO_L18P_T2_A12_D28_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W26   IOSTANDARD LVCMOS25 } [get_ports { data_out[20] }]; #IO_L18N_T2_A11_D27_14 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN T25   IOSTANDARD LVCMOS25 } [get_ports { data_out[19] }]; #IO_L14P_T2_SRCC_14 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN U25   IOSTANDARD LVCMOS25 } [get_ports { data_out[18] }]; #IO_L14N_T2_SRCC_14 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN U22   IOSTANDARD LVCMOS25 } [get_ports { data_out[17] }]; #IO_L21P_T3_DQS_14 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN U23   IOSTANDARD LVCMOS25 } [get_ports { data_out[16] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jb_n[4]

### PMOD Header JC
#set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { data_out[15] }]; #IO_L19P_T3_13 Sch=jc[1]
#set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { data_out[14] }]; #IO_L20P_T3_13 Sch=jc[2]
#set_property -dict { PACKAGE_PIN AH30  IOSTANDARD LVCMOS33 } [get_ports { data_out[13] }]; #IO_L18N_T2_13 Sch=jc[3]
#set_property -dict { PACKAGE_PIN AK29  IOSTANDARD LVCMOS33 } [get_ports { data_out[12] }]; #IO_L15P_T2_DQS_13 Sch=jc[4]
#set_property -dict { PACKAGE_PIN AD26  IOSTANDARD LVCMOS33 } [get_ports { data_out[11] }]; #IO_L19N_T3_VREF_13 Sch=jc[7]
#set_property -dict { PACKAGE_PIN AG30  IOSTANDARD LVCMOS33 } [get_ports { data_out[10] }]; #IO_L18P_T2_13 Sch=jc[8]
#set_property -dict { PACKAGE_PIN AK30  IOSTANDARD LVCMOS33 } [get_ports { data_out[9] }]; #IO_L15N_T2_DQS_13 Sch=jc[9]
#set_property -dict { PACKAGE_PIN AK28  IOSTANDARD LVCMOS33 } [get_ports { data_out[8] }]; #IO_L20N_T3_13 Sch=jc[10]

### PMOD Header JD
# JD pin 1 = nerve-reaction simulation pulse. Drives the external switched-resistor
# phantom that emulates a nerve impedance change: goes high 0.5 ms after each TIS
# onset, for 1 ms, once per 200 ms stimulation, only while a run is active.
# LVCMOS25, NOT the LVCMOS33 in the commented-out Digilent master line: JD sits in
# bank 14 alongside reset, sw6 and the whole JA/JB header, all already at 2.5 V
# here. Same BIVC-1 bank-voltage trap as btnu above. Note the phantom board is
# therefore driven at 2.5 V logic levels, not 3.3 V.
set_property -dict {PACKAGE_PIN V27 IOSTANDARD LVCMOS25} [get_ports nerve_pulse]; #IO_L16N_T2_A15_D31_14 Sch=jd[1]
#set_property -dict { PACKAGE_PIN Y30   IOSTANDARD LVCMOS33 } [get_ports { data_out[6] }]; #IO_L8P_T1_13 Sch=jd[2]
#set_property -dict { PACKAGE_PIN V24   IOSTANDARD LVCMOS33 } [get_ports { data_out[5] }]; #IO_L23N_T3_A02_D18_14 Sch=jd[3]
#set_property -dict { PACKAGE_PIN W22   IOSTANDARD LVCMOS33 } [get_ports { data_out[4] }]; #IO_L24N_T3_A00_D16_14 Sch=jd[4]
#set_property -dict { PACKAGE_PIN U24   IOSTANDARD LVCMOS33 } [get_ports { data_out[3] }]; #IO_L23P_T3_A03_D19_14 Sch=jd[7]
#set_property -dict { PACKAGE_PIN Y26   IOSTANDARD LVCMOS33 } [get_ports { data_out[2] }]; #IO_L1P_T0_13 Sch=jd[8]
#set_property -dict { PACKAGE_PIN V22   IOSTANDARD LVCMOS33 } [get_ports { data_out[1] }]; #IO_L22N_T3_A04_D20_14 Sch=jd[9]
#set_property -dict { PACKAGE_PIN W21   IOSTANDARD LVCMOS33 } [get_ports { data_out[0] }]; #IO_L24P_T3_A01_D17_14 Sch=jd[10]
...
set_property -dict { PACKAGE_PIN M28   IOSTANDARD LVCMOS25 } [get_ports { o_sckb }]; #IO_L14P_T2_SRCC_15 Sch=fmc_ha_p[01]
...
set_property -dict { PACKAGE_PIN N26   IOSTANDARD LVCMOS25 } [get_ports { dac_sync_0 }]; #IO_L18N_T2_A23_15 Sch=fmc_ha_n[03]
set_property -dict { PACKAGE_PIN N25   IOSTANDARD LVCMOS25 } [get_ports { gain_0 }]; #IO_L18P_T2_A24_15 Sch=fmc_ha_p[03]
...
set_property -dict { PACKAGE_PIN N30   IOSTANDARD LVCMOS25 } [get_ports { dac_sclk_0 }]; #IO_L17N_T2_A25_15 Sch=fmc_ha_n[06]
set_property -dict { PACKAGE_PIN N29   IOSTANDARD LVCMOS25 } [get_ports { dac_ldac_0 }]; #IO_L17P_T2_A26_15 Sch=fmc_ha_p[06]
#set_property -dict { PACKAGE_PIN M30   IOSTANDARD LVCMOS12 } [get_ports { FMC_HA_N[07] }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=fmc_ha_n[07]
set_property -dict { PACKAGE_PIN M29   IOSTANDARD LVCMOS25 } [get_ports { reset_0 }]; #IO_L15P_T2_DQS_15 Sch=fmc_ha_p[07]
...
set_property -dict { PACKAGE_PIN K30   IOSTANDARD LVCMOS25 } [get_ports { o_rdlb }]; #IO_L9N_T1_DQS_AD11N_15 Sch=fmc_ha_n[09]
...
set_property -dict { PACKAGE_PIN P23   IOSTANDARD LVCMOS25 } [get_ports { dac_sdo_0 }]; #IO_L21P_T3_DQS_15 Sch=fmc_ha_p[11]
...
set_property -dict { PACKAGE_PIN J26   IOSTANDARD LVCMOS25 } [get_ports { i_sdob }]; #IO_L10N_T1_AD4N_15 Sch=fmc_ha_n[13]
set_property -dict { PACKAGE_PIN K26   IOSTANDARD LVCMOS25 } [get_ports { i_busy }]; #IO_L10P_T1_AD4P_15 Sch=fmc_ha_p[13]
...
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS25 } [get_ports { mux_0[1] }]; #IO_L12N_T1_MRCC_18 Sch=fmc_hb_n[00]
...
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS25 } [get_ports { mux_0[0] }]; #IO_L14N_T2_SRCC_18 Sch=fmc_hb_n[06]
set_property -dict { PACKAGE_PIN F12   IOSTANDARD LVCMOS25 } [get_ports { mux_0[2] }]; #IO_L14P_T2_SRCC_18 Sch=fmc_hb_p[06]
...
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS25 } [get_ports { EIT_IN_EN_0 }]; #IO_L13N_T2_MRCC_18 Sch=fmc_hb_n[17]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS25 } [get_ports { mux_dac2[1] }]; #IO_L13P_T2_MRCC_18 Sch=fmc_hb_p[17]
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS25 } [get_ports { mux_dac2[2] }]; #IO_L20N_T3_18 Sch=fmc_hb_n[18]
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS25 } [get_ports { mux_dac2[0] }]; #IO_L20P_T3_18 Sch=fmc_hb_p[18]
...
set_property -dict { PACKAGE_PIN C26   IOSTANDARD LVCMOS25 } [get_ports { i_drl }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la_n[01]
set_property -dict { PACKAGE_PIN D26   IOSTANDARD LVCMOS25 } [get_ports { o_sdi }]; #IO_L11P_T1_SRCC_16 Sch=fmc_la_p[01]
...
#set_property PACKAGE_PIN P26 [get_ports {dip_switches_8bits_tri_i[6]}]
#set_property PACKAGE_PIN P19 [get_ports {dip_switches_8bits_tri_i[5]}]
#set_property PACKAGE_PIN N19 [get_ports {dip_switches_8bits_tri_i[4]}]
#set_property PACKAGE_PIN K19 [get_ports {dip_switches_8bits_tri_i[3]}]
#set_property PACKAGE_PIN H24 [get_ports {dip_switches_8bits_tri_i[2]}]
#set_property PACKAGE_PIN G25 [get_ports {dip_switches_8bits_tri_i[1]}]
#set_property PACKAGE_PIN G19 [get_ports {dip_switches_8bits_tri_i[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {dip_switches_8bits_tri_i[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {dip_switches_8bits_tri_i[6]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[5]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[4]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[3]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[2]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[1]}]
#set_property IOSTANDARD LVCMOS12 [get_ports {dip_switches_8bits_tri_i[0]}]
