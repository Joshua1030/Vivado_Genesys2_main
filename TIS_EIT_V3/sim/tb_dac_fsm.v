...
module tb_dac_fsm;
    ...
    myip #(
        ...
        // TIS burst gate: held high so channels A/B use their programmed gain.
        // Tie this off explicitly — left unconnected it is X, and the mute term
        // (ch_ab && !tis_on) would poison the gain stage and every DAC word.
        // The TIS window itself is covered by sim/tb_tis_sequencer.v.
        .tis_on      (1'b1),
        .sine_data_A (sine_A),
        .sine_data_B (sine_B),
        .sine_data_C (sine_C),
