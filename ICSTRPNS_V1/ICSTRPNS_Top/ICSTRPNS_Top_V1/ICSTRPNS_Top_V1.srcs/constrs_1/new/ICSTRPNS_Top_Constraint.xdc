...
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS25 } [get_ports { btnd }]; #IO_0_15 Sch=btnd
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS25 } [get_ports { btnl }]; #IO_L6P_T0_15 Sch=btnl
#set_property -dict { PACKAGE_PIN C19   IOSTANDARD LVCMOS25 } [get_ports { btnr }]; #IO_L24P_T3_17 Sch=btnr
...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS25 } [get_ports { sw0_UDP_Reset }]; #IO_0_17 Sch=sw[0]
set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS25 } [get_ports { sw1_AMP_Reset }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS25 } [get_ports { sw2 }]; #IO_L19P_T3_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS25 } [get_ports { sw[3] }]; #IO_L6P_T0_17 Sch=sw[3]
#set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS25 } [get_ports { sw[4] }]; #IO_L19P_T3_A22_15 Sch=sw[4]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS25 } [get_ports { sw[5] }]; #IO_25_15 Sch=sw[5]
#set_property -dict { PACKAGE_PIN P26   IOSTANDARD LVCMOS25 } [get_ports { sw[6] }]; #IO_L10P_T1_D14_14 Sch=sw[6]
#set_property -dict { PACKAGE_PIN P27   IOSTANDARD LVCMOS25 } [get_ports { sw[7] }]; #IO_L8P_T1_D11_14 Sch=sw[7]
...
## PMOD Header JA
set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { sampled_data_0[0] }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { sampled_data_0[1] }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS33 } [get_ports { sampled_data_0[2] }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS33 } [get_ports { sampled_data_0[3] }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_CLK_S_OUT }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
...
set_property -dict { PACKAGE_PIN M27   IOSTANDARD LVCMOS12 } [get_ports { reset_AMP }]; #IO_L16N_T2_A27_15 Sch=fmc_ha_n[14]
...
set_property -dict { PACKAGE_PIN B25   IOSTANDARD LVCMOS25 } [get_ports { AMP_CLK_Chop_0 }]; #IO_L12N_T1_MRCC_16 Sch=fmc_ha_n[17]
set_property -dict { PACKAGE_PIN C25   IOSTANDARD LVCMOS25 } [get_ports { AMP_CLK_Sample_0 }]; #IO_L12P_T1_MRCC_16 Sch=fmc_ha_p[17]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS25 } [get_ports { DEM_CLK_0 }]; #IO_L14N_T2_SRCC_17 Sch=fmc_ha_n[18]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { DATA_0[0] }]; #IO_L14P_T2_SRCC_17 Sch=fmc_ha_p[18]
#set_property -dict { PACKAGE_PIN F30   IOSTANDARD LVCMOS25 } [get_ports { FMC_HA_N[19] }]; #IO_L22N_T3_16 Sch=fmc_ha_n[19]
set_property -dict { PACKAGE_PIN G29   IOSTANDARD LVCMOS25 } [get_ports { AMP_CLK_Push_0 }]; #IO_L22P_T3_16 Sch=fmc_ha_p[19]
set_property -dict { PACKAGE_PIN F27   IOSTANDARD LVCMOS25 } [get_ports { A3_0 }]; #IO_L21N_T3_DQS_16 Sch=fmc_ha_n[20]
set_property -dict { PACKAGE_PIN G27   IOSTANDARD LVCMOS25 } [get_ports { DATA_0[2] }]; #IO_L21P_T3_DQS_16 Sch=fmc_ha_p[20]
set_property -dict { PACKAGE_PIN F28   IOSTANDARD LVCMOS25 } [get_ports { DATA_0[1] }]; #IO_L20N_T3_16 Sch=fmc_ha_n[21]
set_property -dict { PACKAGE_PIN G28   IOSTANDARD LVCMOS25 } [get_ports { M0_0 }]; #IO_L20P_T3_16 Sch=fmc_ha_p[21]
set_property -dict { PACKAGE_PIN C21   IOSTANDARD LVCMOS25 } [get_ports { DATA_0[3] }]; #IO_L8N_T1_17 Sch=fmc_ha_n[22]
set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS25 } [get_ports { OUT_SEL_0[1] }]; #IO_L8P_T1_17 Sch=fmc_ha_p[22]
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS25 } [get_ports { A4_0 }]; #IO_L16N_T2_17 Sch=fmc_ha_n[23]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS25 } [get_ports { A2_0 }]; #IO_L16P_T2_17 Sch=fmc_ha_p[23]
...
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS25 } [get_ports { FMC_HB_P[１２] }]; #IO_L１７P_T２_１８ Sch=fmc_hb_p[１２]
...
#set_property -dict { PACKAGE_PIN F11   IOSTANDARD LVCMOS25 } [get_ports { FMC_HB_P[19] }]; #IO_L16P_T2_18 Sch=fmc_hb_p[１９]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS25 } [get_ports { FMC_HB_N[20] }]; #IO_L24N_T3_18 Sch=fmc_hb_n[20]
#set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS25 } [get_ports { FMC_HB_P[20] }]; #IO_L24P_T3_18 Sch=fmc_hb_p[２０]
...
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS25 } [get_ports { OUT_SEL_0[0] }]; #IO_L2N_T0_17 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_CLKS_OUT }]; #IO_L2P_T0_17 Sch=fmc_la_p[24]
...
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS25 } [get_ports { PINT1_0 }]; #IO_L4P_T0_17 Sch=fmc_la_p[28]
...
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS25 } [get_ports { CLK_S_0 }]; #IO_L20N_T3_17 Sch=fmc_la_n[30]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS25 } [get_ports { CLK_0 }]; #IO_L20P_T3_17 Sch=fmc_la_p[30]
...
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS25 } [get_ports { M1_0 }]; #IO_L1N_T0_17 Sch=fmc_la_n[32]
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS25 } [get_ports { DEM_EN_0 }]; #IO_L1P_T0_17 Sch=fmc_la_p[32]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS25 } [get_ports { CLK_CHOP_0 }]; #IO_L15N_T2_DQS_17 Sch=fmc_la_n[33]
set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS25 } [get_ports { PINT2_0 }]; #IO_L15P_T2_DQS_17 Sch=fmc_la_p[33]
