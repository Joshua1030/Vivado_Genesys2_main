...
## Buttons
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS25 } [get_ports { btnc }]; #IO_25_17 Sch=btnc
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS12 } [get_ports { btnd }]; #IO_0_15 Sch=btnd
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS12 } [get_ports { DS_2ND_OUT }]; #IO_L6P_T0_15 Sch=btnl
#set_property -dict { PACKAGE_PIN C19   IOSTANDARD LVCMOS12 } [get_ports { NS_SAR_ADC_OUTB }]; #IO_L24P_T3_17 Sch=btnr
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS12 } [get_ports { NS_SAR_ADC_OUT }]; #IO_L24N_T3_17 Sch=btnu
...
set_property -dict { PACKAGE_PIN P26   IOSTANDARD LVCMOS33 } [get_ports { SW6 }]; #IO_L10P_T1_D14_14 Sch=sw[6]
...
set_property -dict { PACKAGE_PIN AH24  IOSTANDARD LVCMOS33 } [get_ports { eth_rst_b }]; #IO_L14N_T2_SRCC_12 Sch=eth_phyrst_n
...
## PMOD Header JA
set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { DIN_RST_AMP }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { DIN_CHOP_AMP }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS33 } [get_ports { DIN_AZ_AMP }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS33 } [get_ports { ja[3] }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { DS_2ND_CLK }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN T23   IOSTANDARD LVCMOS33 } [get_ports { DS_BIT_TO_UDP }]; #IO_L5N_T0_D07_14 Sch=ja_n[3]
...
## PMOD Header JB
set_property -dict { PACKAGE_PIN V29   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[0] }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[1] }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V25   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[2] }]; #IO_L18P_T2_A12_D28_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W26   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[3] }]; #IO_L18N_T2_A11_D27_14 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN T25   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[4] }]; #IO_L14P_T2_SRCC_14 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN U25   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[5] }]; #IO_L14N_T2_SRCC_14 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN U22   IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_FEEDBACK[6] }]; #IO_L21P_T3_DQS_14 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN U23   IOSTANDARD LVCMOS33 } [get_ports { jb[7] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jb_n[4]

## PMOD Header JC
set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[0] }]; #IO_L19P_T3_13 Sch=jc[1]
set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[1] }]; #IO_L20P_T3_13 Sch=jc[2]
set_property -dict { PACKAGE_PIN AH30  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[2] }]; #IO_L18N_T2_13 Sch=jc[3]
set_property -dict { PACKAGE_PIN AK29  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[3] }]; #IO_L15P_T2_DQS_13 Sch=jc[4]
set_property -dict { PACKAGE_PIN AD26  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[4] }]; #IO_L19N_T3_VREF_13 Sch=jc[7]
set_property -dict { PACKAGE_PIN AG30  IOSTANDARD LVCMOS33 } [get_ports { Deci_fliter_DS[5] }]; #IO_L18P_T2_13 Sch=jc[8]
...
## PMOD Header JD
set_property -dict { PACKAGE_PIN V27   IOSTANDARD LVCMOS33 } [get_ports { Data[0] }]; #IO_L16N_T2_A15_D31_14 Sch=jd[1]
set_property -dict { PACKAGE_PIN Y30   IOSTANDARD LVCMOS33 } [get_ports { Data[1] }]; #IO_L8P_T1_13 Sch=jd[2]
set_property -dict { PACKAGE_PIN V24   IOSTANDARD LVCMOS33 } [get_ports { Data[2] }]; #IO_L23N_T3_A02_D18_14 Sch=jd[3]
#set_property -dict { PACKAGE_PIN W22   IOSTANDARD LVCMOS33 } [get_ports { jd[3] }]; #IO_L24N_T3_A00_D16_14 Sch=jd[4]
set_property -dict { PACKAGE_PIN U24   IOSTANDARD LVCMOS33 } [get_ports { D[0] }]; #IO_L23P_T3_A03_D19_14 Sch=jd[7]
set_property -dict { PACKAGE_PIN Y26   IOSTANDARD LVCMOS33 } [get_ports { D[1] }]; #IO_L1P_T0_13 Sch=jd[8]
set_property -dict { PACKAGE_PIN V22   IOSTANDARD LVCMOS33 } [get_ports { D[2] }]; #IO_L22N_T3_A04_D20_14 Sch=jd[9]
...
set_property -dict { PACKAGE_PIN K29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[0] }]; #IO_L13N_T2_MRCC_15 Sch=fmc_ha_n[00]
set_property -dict { PACKAGE_PIN K28   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUTB }]; #IO_L13P_T2_MRCC_15 Sch=fmc_ha_p[00]
set_property -dict { PACKAGE_PIN L28   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUT }]; #IO_L14N_T2_SRCC_15 Sch=fmc_ha_n[01]
set_property -dict { PACKAGE_PIN M28   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DIN_CLK }]; #IO_L14P_T2_SRCC_15 Sch=fmc_ha_p[01]
...
set_property -dict { PACKAGE_PIN M24   IOSTANDARD LVCMOS25 } [get_ports { DS_2ND_CLK }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_ha_p[04]
set_property -dict { PACKAGE_PIN H29   IOSTANDARD LVCMOS25 } [get_ports { DS_2ND_OUT }]; #IO_L7N_T1_AD10N_15 Sch=fmc_ha_n[05]
set_property -dict { PACKAGE_PIN J29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[1] }]; #IO_L7P_T1_AD10P_15 Sch=fmc_ha_p[05]
...
set_property -dict { PACKAGE_PIN K30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[4] }]; #IO_L9N_T1_DQS_AD11N_15 Sch=fmc_ha_n[09]
set_property -dict { PACKAGE_PIN L30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[3] }]; #IO_L9P_T1_DQS_AD11P_15 Sch=fmc_ha_p[09]
...
#set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[4] }]; #IO_L5N_T0_AD2N_15 Sch=fmc_ha_n[15]
...
#set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUT }]; #IO_L14P_T2_SRCC_17 Sch=fmc_ha_p[18]
#set_property -dict { PACKAGE_PIN F30   IOSTANDARD LVCMOS12 } [get_ports { FMC_HA_N[19] }]; #IO_L22N_T3_16 Sch=fmc_ha_n[19]
set_property -dict { PACKAGE_PIN G29   IOSTANDARD LVCMOS25 } [get_ports { DIN_AZ_AMP }]; #IO_L22P_T3_16 Sch=fmc_ha_p[19]
#set_property -dict { PACKAGE_PIN F27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[2] }]; #IO_L21N_T3_DQS_16 Sch=fmc_ha_n[20]
#set_property -dict { PACKAGE_PIN G27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_CLKS }]; #IO_L21P_T3_DQS_16 Sch=fmc_ha_p[20]
...
set_property -dict { PACKAGE_PIN C26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_CLKS }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la_n[01]
set_property -dict { PACKAGE_PIN D26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[2] }]; #IO_L11P_T1_SRCC_16 Sch=fmc_la_p[01]
...
set_property -dict { PACKAGE_PIN A30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[7] }]; #IO_L17N_T2_16 Sch=fmc_la_n[05]
set_property -dict { PACKAGE_PIN B30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[6] }]; #IO_L17P_T2_16 Sch=fmc_la_p[05]
set_property -dict { PACKAGE_PIN C30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[5] }]; #IO_L16N_T2_16 Sch=fmc_la_n[06]
set_property -dict { PACKAGE_PIN D29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DINCHOP }]; #IO_L16P_T2_16 Sch=fmc_la_p[06]
...
#set_property -dict { PACKAGE_PIN A26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[6] }]; #IO_L10N_T1_16 Sch=fmc_la_n[11]
...
set_property -dict { PACKAGE_PIN D24   IOSTANDARD LVCMOS25 } [get_ports { DIN_CHOP_AMP }]; #IO_L4N_T0_16 Sch=fmc_la_n[13]
#set_property -dict { PACKAGE_PIN E24   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[0] }]; #IO_L4P_T0_16 Sch=fmc_la_p[13]
...
#set_property -dict { PACKAGE_PIN B23   IOSTANDARD LVCMOS25 } [get_ports { DS_2ND_OUT }]; #IO_L1P_T0_16 Sch=fmc_la_p[15]
...
#set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[1] }]; #IO_L2N_T0_17 Sch=fmc_la_n[24]
#set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS12 } [get_ports { fmc_la_p[24] }]; #IO_L2P_T0_17 Sch=fmc_la_p[24]
set_property -dict { PACKAGE_PIN C22   IOSTANDARD LVCMOS25 } [get_ports { DIN_RST_AMP }]; #IO_L10N_T1_17 Sch=fmc_la_n[25]
...
#set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS25 } [get_ports { DS_2ND_CLK }]; #IO_L4P_T0_17 Sch=fmc_la_p[28]
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[3] }]; #IO_L22N_T3_17 Sch=fmc_la_n[29]
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[5] }]; #IO_L22P_T3_17 Sch=fmc_la_p[29]
#set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DINCHOP }]; #IO_L20N_T3_17 Sch=fmc_la_n[30]
...
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DIN_CLK }]; #IO_L17P_T2_17 Sch=fmc_la_p[31]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS12 } [get_ports { fmc_la_n[32] }]; #IO_L1N_T0_17 Sch=fmc_la_n[32]
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUTB }]; #IO_L1P_T0_17 Sch=fmc_la_p[32]
