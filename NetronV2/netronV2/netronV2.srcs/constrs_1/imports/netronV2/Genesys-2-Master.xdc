...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS25 } [get_ports { SW0_SAR_RESET }]; #IO_0_17 Sch=sw[0]
set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS25 } [get_ports { SW1_DS_RESET }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS25 } [get_ports { SW2_UDP_RESET }]; #IO_L19P_T3_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS25 } [get_ports { SW3_AMP_RESET }]; #IO_L6P_T0_17 Sch=sw[3]
