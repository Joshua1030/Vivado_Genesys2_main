...
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS25 } [get_ports { reset }]; #IO_0_14 Sch=cpu_resetn
...
## PMOD Header JC
set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { CLK_OUT }]; #IO_L19P_T3_13 Sch=jc[1]
set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { DATA_VALID }]; #IO_L20P_T3_13 Sch=jc[2]
set_property -dict { PACKAGE_PIN AH30  IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_CLKS }]; #IO_L18N_T2_13 Sch=jc[3]
set_property -dict { PACKAGE_PIN AK29  IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_DINCHOP }]; #IO_L15P_T2_DQS_13 Sch=jc[4]
set_property -dict { PACKAGE_PIN AD26  IOSTANDARD LVCMOS33 } [get_ports { NS_SAR_ADC_DIN_CLK }]; #IO_L19N_T3_VREF_13 Sch=jc[7]
