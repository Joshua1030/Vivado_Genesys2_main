...
## PMOD Header JA
set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { data_out[31] }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { data_out[30] }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS33 } [get_ports { data_out[29] }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS33 } [get_ports { data_out[28] }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { data_out[27] }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN T23   IOSTANDARD LVCMOS33 } [get_ports { data_out[26] }]; #IO_L5N_T0_D07_14 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { data_out[25] }]; #IO_L4P_T0_D04_14 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN T21   IOSTANDARD LVCMOS33 } [get_ports { data_out[24] }]; #IO_L4N_T0_D05_14 Sch=ja_n[4]

## PMOD Header JB
set_property -dict { PACKAGE_PIN V29   IOSTANDARD LVCMOS33 } [get_ports { data_out[23] }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30   IOSTANDARD LVCMOS33 } [get_ports { data_out[22] }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V25   IOSTANDARD LVCMOS33 } [get_ports { data_out[21] }]; #IO_L18P_T2_A12_D28_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W26   IOSTANDARD LVCMOS33 } [get_ports { data_out[20] }]; #IO_L18N_T2_A11_D27_14 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN T25   IOSTANDARD LVCMOS33 } [get_ports { data_out[19] }]; #IO_L14P_T2_SRCC_14 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN U25   IOSTANDARD LVCMOS33 } [get_ports { data_out[18] }]; #IO_L14N_T2_SRCC_14 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN U22   IOSTANDARD LVCMOS33 } [get_ports { data_out[17] }]; #IO_L21P_T3_DQS_14 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN U23   IOSTANDARD LVCMOS33 } [get_ports { data_out[16] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jb_n[4]
...
# ADC 0
#set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS25} [get_ports i_busy]
#set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS25} [get_ports o_rdlb]
#set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS25} [get_ports o_sdi]
#set_property -dict {PACKAGE_PIN F12 IOSTANDARD LVCMOS25} [get_ports i_sdob]
#set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS25} [get_ports o_sckb]
#set_property -dict {PACKAGE_PIN J11 IOSTANDARD LVCMOS25} [get_ports o_mclk]
#set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS25} [get_ports o_sync]
#set_property -dict {PACKAGE_PIN D11 IOSTANDARD LVCMOS25} [get_ports i_drl]
#set_property -dict {PACKAGE_PIN L12 IOSTANDARD LVCMOS25} [get_ports o_pre]
# ADC 1
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS25 } [get_ports { o_rdlb }];
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS25 } [get_ports { i_busy }];
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS25 } [get_ports { o_sckb }];
set_property -dict { PACKAGE_PIN A12   IOSTANDARD LVCMOS25 } [get_ports { o_sdi }];
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS25 } [get_ports { i_sdob }];
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS25 } [get_ports { o_sync }];
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS25 } [get_ports { i_drl }];
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS25} [get_ports o_pre]
set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS25} [get_ports o_mclk]
...
set_property PACKAGE_PIN P27 [get_ports {dip_switches_8bits_tri_i[7]}]
