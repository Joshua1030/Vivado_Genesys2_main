...
## LEDs
#set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS25 } [ get_ports { led }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
#set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L19P_T3_A10_D26_14 Sch=led[1]
...
## Switches
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS25 } [get_ports { sw[0] }]; #IO_0_17 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS12 } [get_ports { UDP_RESET_SW }]; #IO_L6P_T0_17 Sch=sw[3]
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS12 } [get_ports { SAR_RESET_SW }]; #IO_L19P_T3_A22_15 Sch=sw[4]
...
set_property -dict { PACKAGE_PIN L28   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUTB }]; #IO_L14N_T2_SRCC_15 Sch=fmc_ha_n[01]
...
set_property -dict { PACKAGE_PIN M25   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DIN_CLK }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_ha_n[04]
#set_property -dict { PACKAGE_PIN M24   IOSTANDARD LVCMOS25 } [get_ports { TRD_CLK_Sample_out }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_ha_p[04]
set_property -dict { PACKAGE_PIN H29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[3] }]; #IO_L7N_T1_AD10N_15 Sch=fmc_ha_n[05]
set_property -dict { PACKAGE_PIN J29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_OUT }]; #IO_L7P_T1_AD10P_15 Sch=fmc_ha_p[05]
...
set_property -dict { PACKAGE_PIN J28   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[8] }]; #IO_L8N_T1_AD3N_15 Sch=fmc_ha_n[08]
set_property -dict { PACKAGE_PIN J27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[9] }]; #IO_L8P_T1_AD3P_15 Sch=fmc_ha_p[08]
...
set_property -dict { PACKAGE_PIN L30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[7] }]; #IO_L9P_T1_DQS_AD11P_15 Sch=fmc_ha_p[09]
...
set_property -dict { PACKAGE_PIN P23   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[10] }]; #IO_L21P_T3_DQS_15 Sch=fmc_ha_p[11]
...
set_property -dict { PACKAGE_PIN K26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[14] }]; #IO_L10P_T1_AD4P_15 Sch=fmc_ha_p[13]
...
set_property -dict { PACKAGE_PIN C27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_DINCHOP }]; #IO_L13N_T2_MRCC_16 Sch=fmc_la_n[00]
set_property -dict { PACKAGE_PIN D27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_CLKS }]; #IO_L13P_T2_MRCC_16 Sch=fmc_la_p[00]
set_property -dict { PACKAGE_PIN C26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[0] }]; #IO_L11N_T1_SRCC_16 Sch=fmc_la_n[01]
...
set_property -dict { PACKAGE_PIN E30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[5] }]; #IO_L18N_T2_16 Sch=fmc_la_n[03]
set_property -dict { PACKAGE_PIN E29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[1] }]; #IO_L18P_T2_16 Sch=fmc_la_p[03]
set_property -dict { PACKAGE_PIN H27   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[6] }]; #IO_L23N_T3_16 Sch=fmc_la_n[04]
set_property -dict { PACKAGE_PIN H26   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[2] }]; #IO_L23P_T3_16 Sch=fmc_la_p[04]
set_property -dict { PACKAGE_PIN A30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[13] }]; #IO_L17N_T2_16 Sch=fmc_la_n[05]
set_property -dict { PACKAGE_PIN B30   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[11] }]; #IO_L17P_T2_16 Sch=fmc_la_p[05]
...
set_property -dict { PACKAGE_PIN F25   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[15] }]; #IO_L3P_T0_DQS_16 Sch=fmc_la_p[07]
#set_property -dict { PACKAGE_PIN B29   IOSTANDARD LVCMOS12 } [get_ports { fmc_la_n[08] }]; #IO_L15N_T2_DQS_16 Sch=fmc_la_n[08]
set_property -dict { PACKAGE_PIN C29   IOSTANDARD LVCMOS25 } [get_ports { NS_SAR_ADC_FEEDBACK[12] }]; #IO_L15P_T2_DQS_16 Sch=fmc_la_p[08]
